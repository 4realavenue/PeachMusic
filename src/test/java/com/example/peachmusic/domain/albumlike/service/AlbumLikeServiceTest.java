...
@EnableRetry
@Import({AlbumLikeService.class, AlbumLikeCommand.class, LockRetryExecutor.class, KeysetPolicy.class})
class AlbumLikeServiceTest {
    ...
    void setUp() {
        ...
        tx.execute(status -> {
            ...
            em.createNativeQuery("TRUNCATE TABLE album_likes").executeUpdate();
        ...
        for (Long userId : userIdList) {
            executor.submit(() -> {
                try {
                    ...
                    albumLikeService.likeAlbum(authUser, albumId);
