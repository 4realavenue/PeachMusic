...
public interface AlbumCustomRepository {
    ...
    List<AlbumSearchResponseDto> findAlbumKeysetPageByWord(String word, int size, boolean isAdmin, SortType sortType, SortDirection direction, CursorParam cursor);
    ...
    List<AlbumArtistDetailResponseDto> findAlbumList(Long artistId, int size);
    List<AlbumArtistDetailResponseDto> findAlbumByArtistKeyset(Long artistId, SortType sortType, SortDirection sortDirection, CursorParam cursor, int size);
}
