...
public class AlbumImageUpdateResponseDto {
    ...
    public static AlbumImageUpdateResponseDto from(Album album, List<ArtistSummaryDto> dtoList) {
        return new AlbumImageUpdateResponseDto(
